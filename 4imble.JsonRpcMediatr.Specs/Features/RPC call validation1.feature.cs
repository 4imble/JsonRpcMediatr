...
#line hidden
            ...
            table5.AddRow(new string[] {
                        "{\"jsonrpc\": \"2.0\", \"error\": {\"code\": -32700, \"message\": \"Parse error\"}, \"id\": nul" +
                            "l}"});
#line 23
 testRunner.Then("it should respond with the following response error", ((string)(null)), table5, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table7.AddRow(new string[] {
                        "{\"jsonrpc\": \"2.0\", \"error\": {\"code\": -32600, \"message\": \"Invalid Request\"}, \"id\":" +
                            " null}"});
#line 32
 testRunner.Then("it should respond with the following response error", ((string)(null)), table7, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 46
 testRunner.Given("I have the following RPC request object", ((string)(null)), table10, "Given ");
#line 49
 testRunner.When("I send the request with identifier \'Request1\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            ...
            table11.AddRow(new string[] {
                        "{\"jsonrpc\": \"2.0\", \"error\": {\"code\": -32700, \"message\": \"Parse error\"}, \"id\": nul" +
                            "l }"});
#line 50
 testRunner.Then("it should respond with the following response error", ((string)(null)), table11, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
